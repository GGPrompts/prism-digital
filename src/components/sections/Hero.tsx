...
export function Hero() {
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="content-overlay relative z-10 w-full px-6 py-20 md:px-12 lg:px-20">
        <div className="mx-auto max-w-6xl">
          <div className="space-y-6 md:space-y-8">
            ...
            <p className="mx-auto max-w-2xl text-center text-lg md:text-xl lg:text-2xl text-foreground-muted font-light tracking-wide hero-subtext">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 md:gap-6 pt-4 md:pt-8 hero-cta">
      ...
      <div className="absolute bottom-8 md:bottom-12 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 pointer-events-none hero-scroll">
